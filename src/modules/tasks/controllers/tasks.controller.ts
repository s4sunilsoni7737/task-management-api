...
const TASK_ID_PARAM = { name: 'id', description: 'Task ID', type: 'string', format: 'mongodb ObjectId' } as const;
...
export class TasksController {
  ...
  @ApiParam(TASK_ID_PARAM)
  @ApiParam({ name: 'commentId', description: 'Comment ID', type: 'string', format: 'mongodb ObjectId' })
  async updateComment(
    @Param('id') id: string,
